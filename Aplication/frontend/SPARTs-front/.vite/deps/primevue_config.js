      ...
      return [r].flat().reduce((s3, a2) => {
        if (a2 != null) {
          ...
          if (u === "string" || u === "number") s3.push(a2);
            ...
            let c2 = Array.isArray(a2) ? o(n, a2) : Object.entries(a2).map(([f, g2]) => n === "style" && (g2 || g2 === 0) ? `${f.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}:${g2}` : g2 ? f : void 0);
...
function de(e, t = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g2 = m2[u], f = ve(g2), p3 = z(u, a2) ? Q(d2) : Q(d2, ee(u));
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R, T2, j, O, M, z2, V;
  let { preset: a2, options: n } = t, l2, o, c2, m2, d2, u, g2;
  ...
  if (s(t) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t, { colorScheme: R, extend: T2, css: j } = m2, O = v(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M } = d2, z2 = v(d2, ["colorScheme"]), u = R || {}, { dark: V } = u, L = v(u, ["dark"]), g2 = M || {}, { dark: te } = g2, re = v(g2, ["dark"]), K2 = s(O) ? this._toVariables({ [y2]: h(h({}, O), z2) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: h(h({}, L), re) }, r) : {}, X = s(V) ? this._toVariables({ [y2]: h(h({}, V), te) }, r) : {}, [G2, U2] = [(f = K2.declarations) != null ? f : "", K2.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H, W] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H, "dark", "variable", r, i2, a2, n);
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      let u = z(m2, t.variable.excludedKeyRegex) ? o : o ? `${o}.${oe2(m2)}` : oe2(m2), g2 = c2 ? `${c2}.${m2}` : m2;
      i(d2) ? n(d2, u, g2) : (i2[u] || (i2[u] = { paths: [], computed: (f, x2 = {}, p3 = []) => {
  ...
  if (s(t)) {
    ...
    if (s3 !== "style") {
      ...
      t = r === "dark" ? c2.reduce((m2, { type: d2, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l2, d2, t)), m2), "") : C(l2 != null ? l2 : ":root,:host", t);
    }
    if (o) {
...
var S = { defaults: { variable: { prefix: "p", selector: ":root,:host", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t } = e;
  t && (this._theme = $2(h({}, t), { options: h(h({}, this.defaults.options), t.options) }), this._tokens = b2.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
