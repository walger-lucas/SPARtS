...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.pti()), _toConsumableArray2(_cache[0] || (_cache[0] = [createBaseVNode("rect", {
    width: "1",
    height: "1",
    fill: "currentColor",
    "fill-opacity": "0"
...
var script15 = {
  ...
  watch: {
    ...
    items: {
      handler: function handler6(newValue, oldValue) {
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread2(_objectSpread2({}, group), {}, _defineProperty4({}, typeof _this17.optionGroupChildren === "string" ? _this17.optionGroupChildren : "items", _toConsumableArray6(filteredItems))));
          });
...
export {
  ...
  script15 as script10,
  SelectStyle,
  script16 as script11
};
//# sourceMappingURL=chunk-GLVRVAP4.js.map
